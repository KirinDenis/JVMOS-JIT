...
section .text
	...
	extern sys_draw_rect, sys_fill_rect, sys_draw_line, sys_get_pixel, sys_draw_pixel, sys_present, sys_set_clip, sys_fill_blend, sys_set_blend, sys_str_len, sys_str_byte
	...
	extern c_selftest
	extern wasm_guest_frame, wasm_push_key, wasm_set_sound
...
.sys_str_byte:
    push dword [sys_arg_a]      ; indice
    push dword [sys_arg_c]      ; puntero al literal
    call sys_str_byte
    add esp, 8
    jmp .done
